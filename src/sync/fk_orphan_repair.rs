...
impl FkOrphanRepairCase {
    fn parse(value: &str) -> Result<Self, String> {
        match value {
            ...
            "comics-langs-category" => Ok(Self::ComicsLangsCategory),
            "comics-langs-type" => Ok(Self::ComicsLangsType),
            "releases-name" => Ok(Self::ReleasesName),
            "releases-type" => Ok(Self::ReleasesType),
            "releases-category" => Ok(Self::ReleasesCategory),
            "releases-visibility" => Ok(Self::ReleasesVisibility),
            "releases-id" => Ok(Self::ReleasesId),
            "releases-slug" => Ok(Self::ReleasesSlug),
            "releases-show-in-list" => Ok(Self::ReleasesShowInList),
            "releases-format" => Ok(Self::ReleasesFormat),
    ...
    pub(super) fn spec(self) -> RepairCaseSpec {
        match self {
            Self::ComicsLangsCategory => RepairCaseSpec {
                name: "comics-langs-category",
                constraint_name: "ibfk_accl_category",
                child_table: "comics_langs",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_category_id"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "section_id"],
                update_rule: "CASCADE",
                delete_rule: "RESTRICT",
            },
            Self::ComicsLangsType => RepairCaseSpec {
                name: "comics-langs-type",
                constraint_name: "ibfk_accl_type",
                child_table: "comics_langs",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_type_id"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "comic_type_id"],
                update_rule: "CASCADE",
                delete_rule: "RESTRICT",
            },
            Self::ReleasesName => RepairCaseSpec {
                name: "releases-name",
                constraint_name: "releases_ibfk_1",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_name"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "name"],
                update_rule: "CASCADE",
            ...
            Self::ReleasesType => RepairCaseSpec {
                name: "releases-type",
                constraint_name: "releases_ibfk_10",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_type_id"],
                parent_table: "comics",
            ...
            Self::ReleasesCategory => RepairCaseSpec {
                name: "releases-category",
                constraint_name: "releases_ibfk_2",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_category_id"],
                parent_table: "comics",
            ...
            Self::ReleasesVisibility => RepairCaseSpec {
                name: "releases-visibility",
                constraint_name: "releases_ibfk_3",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_is_visible"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "is_visible"],
                update_rule: "CASCADE",
                delete_rule: "RESTRICT",
            },
            Self::ReleasesId => RepairCaseSpec {
                name: "releases-id",
                constraint_name: "releases_ibfk_6",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id"],
                update_rule: "CASCADE",
            ...
            Self::ReleasesSlug => RepairCaseSpec {
                name: "releases-slug",
                constraint_name: "releases_ibfk_7",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_slug"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["slug"],
                update_rule: "CASCADE",
            ...
            Self::ReleasesShowInList => RepairCaseSpec {
                name: "releases-show-in-list",
                constraint_name: "releases_ibfk_9",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_show_in_list"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "show_in_list"],
                update_rule: "CASCADE",
                delete_rule: "RESTRICT",
            },
            Self::ReleasesFormat => RepairCaseSpec {
                name: "releases-format",
                constraint_name: "releases_ibfk_format",
                child_table: "releases",
                child_primary_key: &["id"],
                child_foreign_key: &["comic_id", "comic_format_id"],
                parent_table: "comics",
                parent_primary_key: &["id"],
                parent_key: &["id", "comic_format_id"],
                update_rule: "CASCADE",
                delete_rule: "RESTRICT",
            },
