...
event; it is not a claim of full combination support. Current proof is semantic
unit coverage. The two real MariaDB/MySQL scenarios (separate-event success and
same-event fail-closed preservation) are in progress and are not deployment
proof.
