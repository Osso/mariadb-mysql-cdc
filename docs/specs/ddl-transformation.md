...
- [ ] The production `home_feed_mantle_spotlights` event at `mysqld-bin.003082:611189718-611194695` has remained `translation_pending` since 2026-09-21 20:41 UTC. Deployment and faithful pending-replay proof remain required before its journal row may promote.
